...
- Запознанство и ФМИ 101.
- Обсъждане какво ще правим и как ще го правим.
- Малко за програмиране и изисквания, за които трябва да знаете.
...
Ако не си бил/а на упражнение или не си схванал/а точните стъпки за инсталация и създаване на C++ проект чрез Visual Studio може да изгледаш **това видео:** https://www.youtube.com/watch?v=IsAoIqnNia4&ab_channel=KodySimpson  
А за ентусиастите, които искат да пишат на Visual Studio Code: https://www.youtube.com/watch?v=77v-Poud_io (файловете трябва да са .cpp, а не .c)
